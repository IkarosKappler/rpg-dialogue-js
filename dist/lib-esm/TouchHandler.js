        ...
        var afProps = {
            ...
            touchMove: function (evt) {
                ...
                if (evt.touches.length == 1 && draggedNode) {
                    ...
                    var diff = new Vertex(pb.transformMousePosition(touchMovePos.x, touchMovePos.y)).difference(trans);
                    if ((_a = draggedNode.editor) === null || _a === void 0 ? void 0 : _a.position) {
        ...
        return function () {
            _this.onTouchEnterEvents.slice().map(function (e, i) {
                if (e[0] === selector && e[1] === fn) {
                    _this.onTouchEnterEvents.splice(1, i);
                }
            });
        };
    };
    TouchEnterLeaveHandler.prototype.onTouchLeave = function (selector, fn) {
        ...
        return function () {
            ...
            this.onTouchLeaveEvents.slice().map(function (e, i) {
                if (e[0] === selector && e[1] === fn) {
                    _this.onTouchLeaveEvents.splice(1, i);
                }
            });
        };
    };
