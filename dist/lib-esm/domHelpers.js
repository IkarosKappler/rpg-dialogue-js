...
var RPGDOMHelpers = /** @class */ (function () {
    function RPGDOMHelpers(editorHelpers) {
        ...
        (_a = document.getElementById("b-export-json")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", this.exportJSON(this));
        (_b = document.getElementById("b-add-answer-option")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", this.addAnswerOption(this));
        (_c = document.getElementById("b-add-dialogue-node")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", this.addDialogueNode(this));
        (_d = document.getElementById("b-delete-dialogue-node")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", this.requestRemoveDialogueNode(this));
    }
    ...
    RPGDOMHelpers.prototype.getSelectedNpcIndex = function () {
        var _a;
        return typeof ((_a = this.currentGraphNode) === null || _a === void 0 ? void 0 : _a.npcIndex) === "undefined" || Number.isNaN(this.currentGraphNode.npcIndex)
            ? 0
    ...
    RPGDOMHelpers.prototype.showAnswerOptions = function (nodeName, graphNode) {
        ...
        _self.touchEnterLeaveHandler.onTouchEnter(".a-droparea", function (element) {
            ...
            _self.currentDropAnswerIndex = parseInt((_a = element.getAttribute("data-dropIndex")) !== null && _a !== void 0 ? _a : "");
        ...
        var drop = function (ev) {
            ...
            var dropIndex = parseInt((_a = target.getAttribute("data-dropindex")) !== null && _a !== void 0 ? _a : "");
        ...
        var isTouchDevice = Boolean((_a = this.editorHelpers.editor.currentTouchHandler) === null || _a === void 0 ? void 0 : _a.wasTouchUsed);
        ...
        for (var i = 0; i < graphNode.o.length; i++) {
            ...
            var handleDragStart = function (ev) {
                ...
                _self.currentDraggedAnswerIndex = parseInt((_a = ev.target.getAttribute("data-answerindex")) !== null && _a !== void 0 ? _a : "");
                // console.log("handleDragStart", _self.currentDraggedAnswerIndex);
                ev.dataTransfer && ev.dataTransfer.setData("answerindex", "".concat(_self.currentDraggedAnswerIndex));
            };
            var handleTouchDragStart = function (ev) {
                var _a, _b;
                ev.preventDefault(); // Is this required?
                var dragStartElement = ev.target;
                _self.currentDraggedAnswerIndex = parseInt((_a = dragStartElement.getAttribute("data-answerindex")) !== null && _a !== void 0 ? _a : "");
                if (Number.isNaN(_self.currentDraggedAnswerIndex)) {
                    ...
                    _self.currentDraggedAnswerIndex = parseInt((_b = dragStartElement.getAttribute("data-answerindex")) !== null && _b !== void 0 ? _b : "");
                }
    ...
    RPGDOMHelpers.prototype.makeAnswerControlElement = function (index, isTouchDevice) {
        ...
        if (isTouchDevice) {
            ...
            downBtn.innerHTML = "▾";
            if (index + 1 === ((_a = this.currentGraphNode) === null || _a === void 0 ? void 0 : _a.o.length)) {
    ...
    RPGDOMHelpers.prototype.handleDeleteOption = function (index) {
        var _a;
        (_a = this.currentGraphNode) === null || _a === void 0 ? void 0 : _a.o.splice(index, 1);
        this.updateAnswerOptions();
        this.editorHelpers.pb.redraw();
    };
    ...
    RPGDOMHelpers.prototype.createNodeSelectOptionElement = function (questionaireText, isCurrent, key, isSelected) {
        ...
        optionElement.innerHTML = "".concat(key !== null && key !== void 0 ? key : "", ": ").concat(EditorHelper.ellipsify(questionaireText, 20));
        if (isCurrent) {
