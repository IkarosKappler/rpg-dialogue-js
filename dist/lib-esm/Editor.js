...
import { KeyHandler, PlotBoilerplate } from "plotboilerplate";
...
var Editor = /** @class */ (function () {
    function Editor(dialogueConfigJSONPath, isRecoveryFromLocalStorageActive, globalLibs) {
        ...
        var isMobileDevice = detectMobileDevice(GUP);
        ...
        // +-------------------------------
        var keyHandler = new KeyHandler({ element: document.getElementsByTagName("body")[0], trackAll: false }).down("escape", function () {
            // Esc?
        ...
        var fileDrop = new FileDrop(this.pb.eventCatcher);
    ...
    Editor.prototype.testCurrentDialogueConfig = function () {
        ...
        var rpgLogic = new RPGDialogueLogic(this.dialogConfig, false);
    ...
    Editor.prototype.tryLoadFromJSON = function (dialogueConfigJSONPath, globalLibs) {
        var _self = this;
        RPGDialogueLogic.loadConfigFromJSON(dialogueConfigJSONPath, globalLibs).then(function (config) {
        ...
        return new Promise(function (accept, reject) {
            ...
            if (!jsonString || jsonString === "") {
                ...
                try {
                    ...
                    var dialogueConfig = EditorHelper.fromObject(jsonObject);
